...
public class SceneSwitcher {
    ...
    // */
    // @DoNotTouch
    // private SceneSwitcher(final Stage stage, final Consumer<GameController>
    // gameLoopStarter) {
    // this.stage = stage;
    ...
    // */
    // @DoNotTouch
    // public static SceneSwitcher getInstance(final Stage stage, final
    // Consumer<GameController> gameLoopStarter) {
    // if (INSTANCE == null) {
    ...
    // if (INSTANCE == null) {
    // throw new IllegalStateException("SceneSwitcher has not been initialized
    // yet.");
    // }
    // return INSTANCE;
    // }
    ...
    // // return new
    // //
    // CreateGameController(SceneSwitcher.getInstance().gameController.getState());
    // }),
    // GAME_BOARD(() -> {
    // //
